let quotes = [
  ...
  [
    'James Monroe',
    'The best form of goverment is that which is most likely to prevent the greatest sum of evil',
  ],
  ['John Quincy Adams', "Try and fail, don't fail to try"],
  [
    'Andrew Jackson',
    'Any many worth his salt will stick up for what he believes right, but it takes a slightly better man to acknowledge instantly without reservation that he is in error',
  ],
  [
    'Martin Van Buren',
  ...
  [
    ...
    'There is nothing more corruption, nothing more destructive of the noblest and finest feelings of our nature than the exercise of unlimited power',
  ],
  [
    'John Tyler',
